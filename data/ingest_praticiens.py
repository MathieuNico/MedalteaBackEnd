    ...
    try:
        with open(path, "rb") as f:
            response = requests.post(
                ...
                files={"file": (path.name, f, "text/csv")} # Content-type for CSV
            )
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Ingest a specific file (e.g. CSV) into the vector database.")
